...
const AI_SYSTEM = [
  ...
  '',
  '칸',
  '- start_time / end_time: 돌봄을 시작한 시각과 마친 시각. 24시간 "HH:MM" (예: 오후 2시 반 → "14:30"). 오전·오후를 말하지 않았으면 돌봄 근무 시간대로 자연스럽게 판단한다. 말하지 않았으면 "".',
  '- client_name: 돌봄 대상이나 장소 (예: "○○○ 어르신 댁", "△△병원"). 없으면 "".',
  '- work_done: 실제로 한 일. 개조식으로 간결하게, 여러 가지면 쉼표로 잇거나 줄을 바꾼다 (예: "식사 준비 및 식사 도움, 투약 확인").',
